...
namespace Lab_1.Domain.Entities.Vehicles;
...
public class ContainerVessel : Vehicle
{
    ...
    {
        return $"Container Vessel '{LicensePlate}' - Capacity: {Capacity}kg - Region: {Region} - TEU: {TEUCapacity} - Refrigerated: {HasRefrigeratedContainers} - Status: {Status}";
    }
}
