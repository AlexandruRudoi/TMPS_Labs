...
namespace Lab_1.Services.Builders;
...
public class ShipmentBuilder : IShipmentBuilder
{
    ...
    public Shipment Build()
    {
        ...
        if (_shipment.TotalWeight > _shipment.AssignedVehicle.Capacity)
            throw new InvalidOperationException($"Total weight ({_shipment.TotalWeight}kg) exceeds vehicle capacity ({_shipment.AssignedVehicle.Capacity}kg)");
