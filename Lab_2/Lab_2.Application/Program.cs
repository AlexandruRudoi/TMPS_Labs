...
class Program
{
    ...
    {
        Console.WriteLine("╔════════════════════════════════════════════════════════════════╗");
        Console.WriteLine("║         Lab 2: Structural Design Patterns                      ║");
        Console.WriteLine("║         Logistics System - Alexandru Rudoi                     ║");
        Console.WriteLine("╚════════════════════════════════════════════════════════════════╝\n");

        // STRUCTURAL PATTERNS - Primary Focus of Lab 2
    ...
    {
        Console.WriteLine("═══════════════════════════════════════════════════════════════");
        Console.WriteLine("PATTERN 1: ADAPTER - Third-Party Tracking Systems Integration");
        Console.WriteLine("═══════════════════════════════════════════════════════════════");
        ...
        Console.WriteLine("- Adapter pattern enables unified interface for different systems");
        Console.WriteLine("- Legacy systems integrated without modifying their code");
        Console.WriteLine("- GPS (coordinates), RFID (dictionary), Barcode (XML) all work seamlessly");
        Console.WriteLine();
    }
    ...
    {
        Console.WriteLine("═══════════════════════════════════════════════════════════════");
        Console.WriteLine("PATTERN 2: DECORATOR - Dynamic Shipment Enhancements");
        Console.WriteLine("═══════════════════════════════════════════════════════════════");
